...
import reflex as rx
@template(route="/leccion2/intro", title="Lección 2", image="/Lock.svg")
def leccion2() -> rx.Component:
    """Lesson 2 Spanish.
    
    Returns:
        The UI for the lesson 2 page for Spanish.
    """
    return rx.chakra.vstack(
        rx.chakra.heading("Lección 2: Entendiendo el Cambio Climático", font_size="3xl", mb=4, align = 'center'),
        ...
        rx.chakra.link(rx.chakra.button("Next"), href = "/leccion2/discusion1", align='end'),
        spacing="2",
        padding="5px",
    )

@template(route="/leccion2/discusion1", title="Lección 2: Discusión 1")
